...
**Source Files:** [`graph_model.py`](file:///c:/Users/Nivetha%20A/OneDrive/Documents/egreen-quanta/graph_model.py), [`cvrp_graph.py`](file:///c:/Users/Nivetha%20A/OneDrive/Documents/egreen-quanta/cvrp_graph.py)
...
- **Why not a complete graph?** In physical road systems, vehicles cannot travel in a straight line from any address to any other address. They must navigate a sparse mesh of streets and intersections.
...
4. **Bridge disjoint islands:** While $M > 1$, add the minimum-distance edge between adjacent components.
